...
// старое создание заявки -> не использ скорее всего
...
func (r *Repository) CreateTransferRequestNEW(requestBody ds.CreateTransferRequestBody, userUUID uuid.UUID) error {
	var orbit_ids []int
...
// старое создание м-м -> не исп скорее всего
